                ...
                <tbody>
                  ${history5.map(h => {
                    ...
                    <tr class="border-b last:border-0 hover:bg-slate-50 transition">
                      ...
                      <td class="text-right"><a href="${API}/contracts/${h.id}/download?token=${auth.token}" class="text-brand-600 font-semibold hover:underline text-xs">Unduh ↓</a></td>
                    </tr>`;
                  }).join("")}
                </tbody>
              </table>
      ...
      <table class="w-full text-sm">
        ...
        <tbody>
          ...
          <tr class="border-b last:border-0">
            ...
            <td class="text-right"><a href="${API}/contracts/${h.id}/download?token=${auth.token}" class="text-brand-600 font-semibold hover:underline">Unduh ↓</a></td>
          </tr>`).join("")}
        </tbody>
      </table>
    </div>`}
...
async function onGenerate() {
  ...
  try {
    ...
    window.location.href = API + "/contracts/" + result.contract.id + "/download?token=" + auth.token;
